...
var capabilityLedger = []struct {
...
}{
	{
		...
		vars: []string{
			...
			"API_ADDR", "PACKAGING_PROFILES_DIR", "SKILLHUB_CLEAN_MODE_RELEASES", "TRUSTED_PROXIES",
		},
	},
	{
	...
	},
	{
		...
		vars: []string{
			...
			"SKILLHUB_SANDBOX_ADDR", "SKILLHUB_SANDBOX_DEV_CMD", "SKILLHUB_SANDBOX_EGRESS_ALLOW",
			"SKILLHUB_SANDBOX_GID", "SKILLHUB_SANDBOX_IMAGE", "SKILLHUB_SANDBOX_P02_INTERVAL_SECONDS",
			"SKILLHUB_SANDBOX_P02_TARGETS", "SKILLHUB_SANDBOX_P02_TIMEOUT_SECONDS", "SKILLHUB_SANDBOX_PROVIDER",
			"SKILLHUB_SANDBOX_RESULT_RETENTION_SECONDS",
			"SKILLHUB_SANDBOX_RUNTIME_VERSION", "SKILLHUB_SANDBOX_SLOTS", "SKILLHUB_SANDBOX_STORAGE_QUOTA",
			"SKILLHUB_SANDBOX_UID",

			"CREATION_MODEL", "ENRICH_MODEL", "GENERATE_SKILL_MODEL", "JUDGE_MODEL",
			"MATCH_REASON_MODEL", "SUGGEST_CRITERIA_MODEL", "INTENT_MODEL",

			"MAINTENANCE_BATCH", "PURGE_GRACE", "REINDEX_BATCH", "REINDEX_REENRICH",
			"SKILLHUB_PURGE_DATABASE_URL",
		},
	},
	{
