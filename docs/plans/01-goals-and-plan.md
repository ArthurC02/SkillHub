...
| M4 打包與封閉測試 | **已收斂**（[m4 對帳](mvp/m4/audit.md)，49 項中 16 勾／33 誠實不勾）。**M4 沒有新增 ADR-030 之後的任何一份 ADR**——ADR-027／028／029 三份在文件批就寫完了，程式批只是兌現它們 | **封測未開始**。`RELEASE-001`～`010` **十項全部不勾**，共同的三個阻擋是甲類四項未到期、PDM 追認、M1 閘門 D 日（[release-checklist](mvp/m4/release-checklist.md)） |
