...
- **給人看的一律標出來、不准剝**。Skill 本文是人要採用的東西，而[鐵律 4](../../AGENTS.md) 說 Skill Version 不可變：顯示時改位元組等於請人簽一份他沒看過的東西。對人的攻擊（Trojan Source，CVE-2021-42574）靠的正是「看起來是一回事、存起來是另一回事」，拿掉那個字元是把騙術藏起來。
