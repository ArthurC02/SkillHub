...
- 驗收證據涵蓋三種輸入各至少一條真實多輪任務，包含使用者更正、人工確認、至少一輪依驗證回饋修訂；用固定草稿與真實 Run 評估任務效果，分開報告格式通過、任務達成、人類願意採用及成本／等待時間，附樣本與分母。與同一批任務的單次生成基礎比較，不能只用 HTTP 200 或 mock 宣稱創作品質改善。<br>**2026-09-06 補充**：harness 已在 repo（`TestCreationMeasureFifteenSessionsAgainstSingleShot`，[跑法](mvp/m5/creation-measure/README.md)），門檻取 `05` R-45；**尚未跑**——啟動付費閘道不在代理權限內。
