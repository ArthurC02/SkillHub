...
| CONTENT-003 首批候選清單 | **部分完成** | [curated-skill-list.md](../content/curated-skill-list.md)、`tools/content/seed-skills.json`（45 筆）。**2026-08-15 補足後三類數量目標全部達標**（`documents` 精選 3→4，見該文件 §9） | **不勾。** 九項檢查的 ⑤⑦⑧ 對全部 45 筆仍為 `pending`，⑤⑦⑧ 分別由 CONTENT-006／005／007＋008 承接；該文件 §3 已自訂「四者全數完成前不得勾選」。**數量缺口已關閉，品質檢查缺口未關閉** |
...
本對帳進行期間，另一位協作者於 `03-work-items.md` **新增並自行勾選** INGEST-011（內嵌可執行程式碼揭露，`02:SKILL-003`）、INGEST-012（License 多層溯源，`02:SKILL-004`／[打包、授權溯源與散布](../../../adr/README.md#打包授權溯源與散布)）、INGEST-013（外部 URL 依主機聚合，`02:SKILL-005`）。
...
| CONTENT-003 勾選條件解綁 | `03` CONTENT-003、[curated-skill-list.md](../content/curated-skill-list.md) §3 | ⑧ 不再是勾選前提，改為引用 CONTENT-007／008 並須記為「待 M2」；⑤⑦ 對 CONTENT-006／005 的綁定不變 |
