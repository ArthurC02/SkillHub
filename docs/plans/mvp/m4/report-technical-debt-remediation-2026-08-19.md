...
| --- | --- | --- | --- |
| `DEPLOY-IAC-001` | deployment | 部署負責人建立 [Sandbox 隔離與執行安全](../../../adr/README.md#sandbox-隔離與執行安全) 所定 sandbox node IaC，完成真機安全驗收 | [release-checklist §2.1](release-checklist.md)：IaC、pinned network 與 SEC-009 證據 |
