...
| [`writing-rubrics.md`](writing-rubrics.md) | `writing` 5 個精選的**預設 rubric**（`rubric_version = content-007/writing/v1`）與缺口對帳；機器可讀版在 [`tools/eval-regression/rubric-content-007-writing-v1.json`](../../../../tools/eval-regression/rubric-content-007-writing-v1.json) | CONTENT-007（**2026-08-17 已勾**；G1～G4 關閉，新缺口 G7 記於 `04` 乙-13） | 活文件（2026-08-17 新增） |
| [`content-candidates.md`](content-candidates.md) | 已被 `curated-skill-list.md` 取代的候選盤點初稿 | CONTENT-003 前身 | 可視為凍結 |

- **出處**：M1 的 CONTENT-003／005（原 `m1/`），2026-08-16 依[Repo 結構、CI 與驗證層](../../../adr/README.md#repo-結構ci-與驗證層)歸位至此；`writing-rubrics.md` 為 2026-08-17 的 CONTENT-007 產出，依同一條規則落在本目錄而非 `m3/`。
