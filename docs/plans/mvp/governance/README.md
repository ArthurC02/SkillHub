...
- **出處**：M2 的 `anthropics/skills` source-available 處置（原 `m2/`），2026-08-16 依 [Repo 結構、CI 與驗證層](../../../adr/README.md#repo-結構ci-與驗證層) 歸位至此。
