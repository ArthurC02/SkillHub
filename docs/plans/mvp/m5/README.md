...
| **前期驗證 2** | 使用者搜不到之後，**自發**說出的下一步是什麼？ | **零**——掛在本來就要跑的 M1 閘門上 | 材料已就位（[gate-test/moderator-guide.md §3.D](../gate-test/moderator-guide.md)），**待 D 日**。只在該場最後一張干擾卡之後問，不參與 G1～G4 任何一條判準 |
