...
| 3 | ~~`GEN-009` 生成品質基線~~ **已放行** | **①②與 (甲)(乙) 已完成** → `report-generate-spike.md`（A 輪）、`report-generate-baseline.md`（B 輪＋mini）。~~**剩 ③④**——要 Sandbox、評估管線與人~~ **2026-08-28：③ 完成**（D 輪，20／20 生成＋試跑＋判定，報告 §9、原始資料 `gen009-round-d/`）。**剩 ④，它要人**：「人看了會不會留著」沒有機器代得了。 |
