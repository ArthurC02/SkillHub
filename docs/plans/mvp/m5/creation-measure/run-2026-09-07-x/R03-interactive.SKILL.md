...
4. If any required input is missing, stop and ask only for that missing input.
...
8. Include the three source URLs and the recipient email address in the final output.
9. Do not introduce any additional news sources, destinations, or assumptions.
