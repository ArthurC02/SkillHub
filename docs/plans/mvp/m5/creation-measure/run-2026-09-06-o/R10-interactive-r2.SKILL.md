...
- 不要輸出任何待補、占位或假設中的訊息連結；只有在輸入真的含有連結時才填入連結。
...
- 如果輸入沒有提供訊息連結，這個 skill 必須停止並回覆「not given」作為整份輸出的連結欄位，不得捏造或保留待補占位符。
- 如果輸入沒有明確指出三個頻道是哪些，寫 `not given`。

## 輸出格式
以單一清單輸出，只列出未回覆的問題；不要輸出已回覆、已處理或排除的訊息。每筆一行或一個條目，至少包含：
- 頻道名稱
- 問題內容
- 訊息連結
