...
3. Output the Skill specification itself in Markdown, with no alternative方案、no follow-up questions, and no plain restatement of the request.
...
- Outputs: 5 summaries and an email delivery result.
