...
| [ADR-073](./ADR-073-account-deletion-keeps-the-credit-ledger.md) | 帳號刪除不清 Credit 紀錄：清除流程不再刪扣點分錄、成本事件與會話摘要，時間視窗的保存掃描照舊（取代 ADR-068 決策 11 的帳號刪除那一半） | Accepted |
