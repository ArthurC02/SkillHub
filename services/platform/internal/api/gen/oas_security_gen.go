...
type SecurityHandler interface {
	...
	// (services/platform/internal/identity/http.go). HttpOnly, SameSite=Lax, Secure outside plain-http
	// local dev, so a browser sends it on its own and no client code reads or sets it - the generated TS
	// client only has to send credentials with the request.
	//
