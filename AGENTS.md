...
| `docs/adr/` | 35 份架構決策紀錄（ADR-000～034；014 已由 018 取代，024 已由 031 取代，019 §1 現由 031 修訂） | [docs/adr/README.md](docs/adr/README.md)（含索引與架構總圖） |
...
- 新 ADR 從 **ADR-035** 起編；選型類決策採 ADR-016 格式（含「評估選項」比較），邊界類可用精簡格式。
