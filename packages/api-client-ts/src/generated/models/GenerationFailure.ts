...
export interface GenerationFailure {
     ...
     * is not called `quota`; `credit` never reached it because the account's balance was below the start threshold; `gateway` is the model service or the proxy; `unpackageable` is an answer that parsed
