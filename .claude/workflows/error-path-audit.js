...
const DEFAULT_LINES = [
  { key: 'discover', web: ['src/features/catalog/home/','src/features/catalog/compare/Compare.page.tsx', 'src/shared/ui/RiskIndicator.tsx', 'src/shared/ui/CompatibilityStatus.tsx', 'src/features/skill/skills.service.ts'], go: ['skill/discovery/http.go'], tests: ['src/features/catalog/disc.test.tsx', 'src/features/catalog/compare.test.tsx'] },
  { key: 'detail', web: ['src/features/skill/detail/','src/features/skill/files/SkillFiles.page.tsx', 'src/shared/ui/LicenseBadge.tsx', 'src/shared/ui/LabelledBadge.tsx'], go: ['skill/discovery/http.go', 'skill/library/http.go', 'creator/workspace/http.go'], tests: ['src/features/skill/detail.test.tsx', 'src/guards/session.test.tsx'] },
  ...
  { key: 'lab', web: ['src/features/lab/test-cases/','src/features/lab/dataset-upload/DatasetUpload.page.tsx', 'src/features/lab/testcases.service.ts', 'src/features/lab/lab.service.ts'], go: ['trial/design/http.go'], tests: ['src/features/lab/testcases.test.tsx', 'src/features/lab/dataset.test.tsx'] },
  { key: 'packaging', web: ['src/features/packaging/build/','src/features/packaging/downloads/Downloads.page.tsx', 'src/features/packaging/components/DownloadArtifactFacts.tsx', 'src/features/packaging/packaging.service.ts'], go: ['skill/delivery/http.go'], tests: ['src/features/packaging/packaging.test.tsx'] },
