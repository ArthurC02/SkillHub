...
const DEFAULT_LINES = [
  { key: 'discover', web: ['src/features/catalog/home/Home.page.tsx', 'src/features/catalog/compare/Compare.page.tsx', 'src/shared/ui/RiskIndicator.tsx', 'src/shared/ui/CompatibilityStatus.tsx', 'src/features/skill/skills.service.ts'], go: ['skill/discovery/http.go'], tests: ['src/features/catalog/disc.test.tsx', 'src/features/catalog/compare.test.tsx'] },
  { key: 'detail', web: ['src/features/skill/detail/SkillDetail.page.tsx', 'src/features/skill/files/SkillFiles.page.tsx', 'src/shared/ui/LicenseBadge.tsx', 'src/shared/ui/LabelledBadge.tsx'], go: ['skill/discovery/http.go', 'skill/library/http.go', 'creator/workspace/http.go'], tests: ['src/features/skill/detail.test.tsx', 'src/guards/session.test.tsx'] },
  { key: 'import', web: ['src/features/creation/import/ImportSkill.page.tsx', 'src/features/workspace/skills/WorkspaceSkills.page.tsx', 'src/features/creation/components/CreateHub.tsx', 'src/features/skill/detail/components/VersionUpload.tsx', 'src/shared/ui/ConfirmDelete.tsx', 'src/shared/ui/Findings.tsx'], go: ['skill/admission/http.go', 'skill/library/http.go'], tests: ['src/features/workspace/workspace.test.tsx'] },
  { key: 'lab', web: ['src/features/lab/test-cases/TestCases.page.tsx', 'src/features/lab/dataset-upload/DatasetUpload.page.tsx', 'src/features/lab/testcases.service.ts', 'src/features/lab/lab.service.ts'], go: ['trial/design/http.go'], tests: ['src/features/lab/testcases.test.tsx', 'src/features/lab/dataset.test.tsx'] },
  { key: 'packaging', web: ['src/features/packaging/build/Packaging.page.tsx', 'src/features/packaging/downloads/Downloads.page.tsx', 'src/features/packaging/components/DownloadArtifactFacts.tsx', 'src/features/packaging/packaging.service.ts'], go: ['skill/delivery/http.go'], tests: ['src/features/packaging/packaging.test.tsx'] },
  { key: 'account', web: ['src/features/workspace/account/WorkspaceAccount.page.tsx', 'src/features/workspace/policy/DataPolicy.page.tsx', 'src/app/shell/FeedbackEntry.tsx', 'src/app/shell/AuthControls.tsx', 'src/shared/ui/SignIn.tsx', 'src/app/shell/CleanModeNotice.tsx', 'src/core/session/me.service.ts', 'src/app/shell/feedback.service.ts'], go: ['creator/workspace/http.go', 'product/learning/feedback.go'], tests: ['src/guards/session.test.tsx', 'src/app/shell/feedback.test.tsx', 'src/shared/ui/signin.test.tsx', 'src/features/workspace/policy.test.tsx', 'src/app/clean-mode.test.tsx'] },
]
...
const CONTEXT = [
  ...
  'Conventions already in the code: `ReadFailure`/`LoginRequired` in apps/web/src/shared/ui/LoginRequired.tsx (401 → 「需要登入」 + sign-in; otherwise children or 「無法讀取{what}：{message}」); `ApiError` in apps/web/src/core/api/client.ts carries status and body; Go handlers answer `{"error": "..."}` via httpx.WriteError; `Labelled` {value,label,note} is the served-words shape for enums.',
