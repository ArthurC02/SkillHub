...
| [ADR-022](./ADR-022-sandbox-deployment-topology-and-security-thresholds.md) | Sandbox 部署拓撲與安全驗收定值（節點編排／租戶模型／Egress；SEC-002 六項門檻；SEC-009 驗收程序；補充決策：Container registry 採 GHCR，回答 ADR-019 待決策 1） | Accepted |
