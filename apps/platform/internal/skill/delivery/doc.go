// Package packaging is the current Go package for ADR-038's proposed product
// domain 「Skill 交付與安裝」: it lets creators obtain a portable, traceable Skill
// package that satisfies distribution conditions. Its stable Boundary ID/package
// slug remains `packaging`; ADR-038 is Proposed and does not rename it.
// It turns an immutable Skill Version into a downloadable package (ADR-032 §1 Packaging & Distribution, requirement prefix PACK; PACK-001..005, ADR-012, ADR-027).
//
...
// source, the applied suggestions — is read through owner APIs adapted at the
// composition root. Registry and ingest generated rows do not cross this package
// boundary; the writes stay with their owners.
//
// # Public face
//
...
// visibility — see internal/foundation/observability/audit.
//
