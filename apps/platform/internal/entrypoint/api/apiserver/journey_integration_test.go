...
func TestTheCoreJourneyRunsFromIntentSearchToADownloadedPackage(t *testing.T) {
	...
	var forkID, forkVersionID, testCaseID, criterionID string

	if !t.Run("catalog discovery", func(t *testing.T) {
	...
	if !t.Run("fork and test design", func(t *testing.T) {
	...
	if !t.Run("run orchestration and evaluation", func(t *testing.T) {
