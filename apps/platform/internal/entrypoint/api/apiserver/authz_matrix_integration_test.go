...
var anonymousRoutes = []anonCase{
	...
	{pattern: "POST /me/bundles/{name}/publication", want: http.StatusUnauthorized},
	{pattern: "DELETE /me/bundles/{name}/publication", want: http.StatusUnauthorized},
	...
	{pattern: "GET /admin/exposure-reviews", want: http.StatusNotFound},
	{pattern: "GET /admin/publications/{publisher}/{name}/exposure", want: http.StatusNotFound},
	{pattern: "POST /admin/publications/{publisher}/{name}/exposure", want: http.StatusNotFound},
	...
	{pattern: "GET /admin/accounts", want: http.StatusNotFound},
	{pattern: "GET /admin/rosters", want: http.StatusNotFound},
	{pattern: "GET /admin/skills", want: http.StatusNotFound},
	{pattern: "GET /admin/audit-log", want: http.StatusNotFound},
	{pattern: "GET /admin/model-budgets", want: http.StatusNotFound},
	{pattern: "PUT /admin/model-budgets/{kind}", want: http.StatusNotFound},
	{pattern: "DELETE /admin/model-budgets/{kind}", want: http.StatusNotFound},
	...
	{pattern: "GET /admin/trends/funnel", want: http.StatusNotFound},
