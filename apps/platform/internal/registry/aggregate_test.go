...
// internal/identity's service: what is under test is this aggregate's rules, and
...
func commitVersion(t *testing.T, pool *pgxpool.Pool, v NewVersion) (gen.SkillVersion, error) {
	t.Helper()
	ctx := context.Background()
