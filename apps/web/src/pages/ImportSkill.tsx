    ...
    <section>
      ...
      */}
      <ul className="note">
        ...
        <li>
          {/* 2026-09-08：句尾的「所以這裡不印一個沒有來源的數字」走了。那半句是**寫給
              下一個工程師的理由**（為什麼這裡沒有數字），不是讀者的判斷依據；它逐字印
              在畫面上，而外部審查把整頁讀成「工程備註」。§2.2 要的兩件事都留著：限制是
              真的（平台強制兩個上限）、撞上之前先說（拒絕訊息會給數字）。 */}
          大小上限見拒絕訊息——平台對 zip 與解壓後各強制一個上限，這一頁還讀不到它們的數字。
        </li>
        {/*
