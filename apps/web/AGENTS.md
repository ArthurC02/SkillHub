...
| 熱路徑的文字量、摺疊、Tip、icon                    | system.md §2.13、§4.7 與 [ADR-065](../../docs/adr/ADR-065-hot-path-text-budget-and-the-fourth-disclosure-mechanism.md)                   | `src/a11y.test.tsx`（但書守衛 ＋ 清單重複句 ratchet）                                                      |
